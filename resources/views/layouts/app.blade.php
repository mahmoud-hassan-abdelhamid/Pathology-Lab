            ...
            @if(Auth::check())
                <ul class="nav navbar-nav">
                    ...
                    @if(Auth::user()->type()=='patient')
                        <li><a href="{{ url('/patients/reports') }}">Reports</a></li>
                    @endif
                </ul>
        @endif
...
<script src="{{ url('js/typeahead.js/bloodhound.min.js') }}"></script>
<script src="{{ url('js/typeahead.js/typeahead.jquery.min.js') }}"></script>
<script src="{{ url('js/typeahead.js/typeahead.bundle.min.js') }}"></script>
